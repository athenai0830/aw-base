...
<div class="sns-share-wrap">
    ...
    <div class="sns-share-buttons">
        ...
        <a href="https://social-plugins.line.me/lineit/share?url=<?php echo esc_attr( $url ); ?>"
        ...
        <a href="https://getpocket.com/save?url=<?php echo esc_attr( $url ); ?>&title=<?php echo esc_attr( $title ); ?>"
        ...
        <a href="https://b.hatena.ne.jp/add?mode=confirm&url=<?php echo esc_attr( $url ); ?>&title=<?php echo esc_attr( $title ); ?>"
        ...
        <a href="https://feedly.com/i/subscription/feed/<?php echo esc_attr( $rss_url ); ?>"
        ...
        <a href="https://pinterest.com/pin/create/button/?url=<?php echo esc_attr( $url ); ?>&description=<?php echo esc_attr( $title ); ?>"
