...
// Get thumbnail
$thumb_url = has_post_thumbnail() ? get_the_post_thumbnail_url(get_the_ID(), 'large') : get_template_directory_uri() . '/assets/img/no-image.png';
...
<article id="post-<?php the_ID(); ?>" <?php post_class('entry-card'); ?>>
    <a href="<?php the_permalink(); ?>" class="entry-card-link">
        ...
        <div class="entry-card-content">
            <h2 class="entry-card-title"><?php the_title(); ?></h2>
